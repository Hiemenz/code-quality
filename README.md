...
| Style | 12 | Long lines, trailing whitespace, TODO markers, bare `except:`, `except Exception: pass`-style silent swallowing, raising a new exception without chaining from the original, wildcard imports, mutable default arguments, unused imports/variables, non-conventional naming |
...
unclosed resources, query-in-loop, and circular imports.
